...
const Hero: React.FC = () => {
  ...
  return (
    <div className="relative w-full min-h-[100dvh] flex flex-col overflow-hidden bg-[#050505]">
      ...
      <header className="relative z-10 flex-grow flex flex-col justify-start px-6 md:px-16 lg:px-24 pt-[200px] pb-32">

        {/* Decorative Tagline */}
        <div className="flex items-center gap-3 md:gap-4 mb-6 md:mb-8">
          <div className="w-8 md:w-12 h-[3px] bg-[#00BFFF] rounded-full shadow-[0_0_10px_rgba(0,191,255,0.4)]"></div>
          <span className="text-[10px] md:text-xs font-medium tracking-[0.25em] text-[#00BFFF] uppercase drop-shadow-sm">Toronto-Based Software Agency</span>
        </div>

        {/* Primary Heading — single H1 per page for SEO */}
        <h1 className="sr-only">Pureum Software – Toronto Software Development, iOS & Android Apps, SEO & AI Solutions</h1>
        ...
        <p className="max-w-sm text-gray-300 font-light leading-relaxed text-sm border-l-2 border-white/20 pl-4 md:pl-6 backdrop-blur-sm bg-black/10 rounded-r-lg py-2">
          Specializing in high-performance iOS & Android applications with SEO & GEO optimization. We turn complex ideas into seamless digital experiences — serving Toronto, GTA, and clients across Canada.
        </p>
      </header>
